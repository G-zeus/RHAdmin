        ...
        <div class="container">
            ...
            <form action="" class="form-horizontal">
                ...
                <div class="form-group left">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="emergency_contact" id="emergency_contact" v-model="emergency_contact">
                    </div>
                </div>
                ...
                <div class="form-group left row ">
                    <div class="col">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="emergency_phone" id="emergency_phone" v-model="emergency_phone">
                        </div>
                    </div>
                    <div class="col">
